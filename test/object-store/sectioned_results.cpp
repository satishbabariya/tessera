...
namespace tessera::sectioned_results_fixtures {
...
struct MixedVal : Base<PropertyType::Mixed, tessera::Mixed> {
    ...
    {
        return {Mixed{tessera::UUID()},      Mixed{int64_t(1)},
    ...
    static std::vector<tessera::Mixed> expected_sorted()
    {
...
struct UUID : Base<PropertyType::UUID, tessera::UUID> {
    ...
    {
        return {
            tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999"), tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
            tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
            tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999"), tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999"),
        };
    }

    static std::vector<tessera::UUID> expected_sorted()
    {
        return {
            tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
            tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"), tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
    ...
    static std::vector<Mixed> expected_keys()
    {
        return {tessera::UUID("1a241101-e2bb-4255-8caf-4136c566a962"),
                tessera::UUID("1b241101-a2b3-4255-8caf-4136c566a999")};
    }
...
struct UnboxedOptional : BaseT {
    ...
    static auto expected_sorted() -> decltype(BaseT::values())
    {
        ...
        if constexpr (std::is_same_v<BaseT, sectioned_results_fixtures::Decimal>) {
            // The default Decimal128 ctr is 0, but we want a null value
            ret.insert(ret.begin(), Decimal128(tessera::null()));
        }
        else {
...
namespace cf = tessera::sectioned_results_fixtures;
