...
#ifndef TESSERA_UTILITIES_HPP
#define TESSERA_UTILITIES_HPP
...
#define TESSERA_X86_OR_X64
#define TESSERA_X86_OR_X64_TRUE true
#else
#define TESSERA_X86_OR_X64_TRUE false
#endif

// GCC defines __arm__
#ifdef __arm__
#define TESSERA_ARCH_ARM
#endif
...
#define TESSERA_PTR_64
#endif


#if defined(TESSERA_PTR_64) && defined(TESSERA_X86_OR_X64) && !TESSERA_WATCHOS
#define TESSERA_COMPILER_SSE // Compiler supports SSE 4.2 through __builtin_ accessors or back-end assembler
#define TESSERA_COMPILER_AVX
#endif
...
TESSERA_FORCEINLINE bool sseavx()
{
    /*
...
{
    TESSERA_ASSERT_DEBUG(!util::int_cast_has_overflow<size_t>(v));
    return size_t(v);
}
...
// Use tessera::safe_equal() instead of std::equal() if one of the parameters can be a null pointer.
...
// Use tessera::safe_copy_n() instead of std::copy_n() if one of the parameters can be a null pointer. See the
