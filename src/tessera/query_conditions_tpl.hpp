...
#ifndef TESSERA_QUERY_CONDITIONS_TPL_HPP
#define TESSERA_QUERY_CONDITIONS_TPL_HPP
...
public:
    ...
    {
        if (m_source_column) {
            TESSERA_ASSERT_DEBUG(value.is_null());
    ...
    {
        TESSERA_ASSERT(m_source_column);
...
#endif /* TESSERA_QUERY_CONDITIONS_TPL_HPP */
