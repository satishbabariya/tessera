...
#ifndef TESSERA_COLUMN_TYPE_TRAITS_HPP
#define TESSERA_COLUMN_TYPE_TRAITS_HPP
...
struct ObjectTypeTraits {
    constexpr static bool self_contained_null =
        tessera::is_any_v<T, StringData, BinaryData, Decimal128, Timestamp, Mixed>;
};
...
#endif // TESSERA_COLUMN_TYPE_TRAITS_HPP
