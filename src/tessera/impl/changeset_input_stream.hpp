...
#ifndef TESSERA_IMPL_INPUT_STREAM_HPP
#define TESSERA_IMPL_INPUT_STREAM_HPP

#include <tessera/util/input_stream.hpp>

#include <tessera/column_binary.hpp>
...
public:
    ...
    util::Span<const char> next_block() override
    {
        while (m_valid) {
            ...
            if (TESSERA_UNLIKELY(m_changesets_begin == m_changesets_end)) {
                get_changeset();
            }
        }
...
#endif // TESSERA_IMPL_INPUT_STREAM_HPP
