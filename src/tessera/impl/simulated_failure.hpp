...
#ifndef TESSERA_IMPL_SIMULATED_FAILURE_HPP
#define TESSERA_IMPL_SIMULATED_FAILURE_HPP
...
#ifdef TESSERA_DEBUG
#define TESSERA_ENABLE_SIMULATED_FAILURE
#endif
...
public:
    ...
    /// type on the calling thread, but only if TESSERA_ENABLE_SIMULATED_FAILURE
    /// was defined during compilation. If TESSERA_ENABLE_SIMULATED_FAILURE was
    ...
    /// Returns true when, and only when TESSERA_ENABLE_SIMULATED_FAILURE was
...
private:
#ifdef TESSERA_ENABLE_SIMULATED_FAILURE
...
template <>
struct is_error_code_enum<tessera::_impl::SimulatedFailure::FailureType> {
...
#endif // TESSERA_IMPL_SIMULATED_FAILURE_HPP
