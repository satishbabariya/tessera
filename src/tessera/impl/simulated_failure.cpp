...
void create() noexcept
{
    ...
    if (TESSERA_UNLIKELY(ret != 0)) {
        ...
        TESSERA_TERMINATE(ec.message().c_str());
    }
}
...
#if !defined(__clang__) || TESSERA_HAVE_CLANG_FEATURE(cxx_thread_local)
thread_local
#endif
...
#endif // TESSERA_ENABLE_SIMULATED_FAILURE
