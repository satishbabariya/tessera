...
#ifndef TESSERA_ARRAY_BLOBS_SMALL_HPP
#define TESSERA_ARRAY_BLOBS_SMALL_HPP
...
{
    TESSERA_ASSERT_3(ndx, <, m_offsets.size());
...
{
    TESSERA_ASSERT_3(ndx, <, m_nulls.size());
...
{
    TESSERA_ASSERT(new_size == 0 || new_size < m_offsets.size());
...
#endif // TESSERA_ARRAY_BINARY_HPP
