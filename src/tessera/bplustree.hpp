...
#ifndef TESSERA_BPLUSTREE_HPP
#define TESSERA_BPLUSTREE_HPP
...
public:
    ...
    public:
        ...
        void bp_set_parent(tessera::ArrayParent* p, size_t n) override
        {
    ...
    TESSERA_NOINLINE T get_uncached(size_t n) const
    {
        T value;
    ...
    {
        while (m_root->get_node_size() > TESSERA_MAX_BPNODE_SIZE) {
            split_root();
        }
    }
