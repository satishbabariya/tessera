...
#ifndef TESSERA_ARRAY_DECIMAL128_HPP
#define TESSERA_ARRAY_DECIMAL128_HPP
...
public:
    ...
    {
        return nullable ? Decimal128(tessera::null()) : Decimal128(0);
    }
    ...
    {
        TESSERA_ASSERT(ndx < m_size);
        switch (m_width) {
            case 0:
                return get_context_flag() ? Decimal128() : Decimal128(tessera::null());
            case 4: {
    ...
    {
        set(ndx, Decimal128(tessera::null()));
    }
...
#endif /* TESSERA_ARRAY_DECIMAL128_HPP */
