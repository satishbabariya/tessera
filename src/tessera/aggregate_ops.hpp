...
#ifndef TESSERA_AGGREGATE_OPS_HPP
#define TESSERA_AGGREGATE_OPS_HPP
...
namespace tessera::aggregate_operations {
...
class Sum {
public:
    using ResultType = typename tessera::ColumnSumType<T>;
...
class Average {
public:
    using ResultType = typename std::conditional<tessera::is_any_v<T, Decimal128, Mixed>, Decimal128, double>::type;
    ...
    ResultType result() const
    {
        TESSERA_ASSERT_EX(m_count > 0, m_count);
...
#endif // TESSERA_AGGREGATE_OPS_HPP
