...
#ifndef TESSERA_REPLICATION_HPP
#define TESSERA_REPLICATION_HPP
...
public:
    ...
    enum HistoryType {
        ...
        /// synchronization protocol (tessera::sync::ClientHistory).
        hist_SyncClient = 3,

        /// In-Realm history supporting continuous transactions and server-side
        /// synchronization protocol (tessera::_impl::ServerHistory).
        hist_SyncServer = 4
    };
