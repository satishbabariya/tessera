...
#ifndef TESSERA_ARRAY_FIXED_BYTES_HPP
#define TESSERA_ARRAY_FIXED_BYTES_HPP
...
public:
    ...
    {
        TESSERA_ASSERT(is_valid_ndx(ndx));
        TESSERA_ASSERT(!is_null(ndx));
...
#endif /* TESSERA_ARRAY_FIXED_BYTES_HPP */
