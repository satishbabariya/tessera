...
#ifndef TESSERA_DECIMAL_HPP
#define TESSERA_DECIMAL_HPP
...
namespace std {
template <>
struct numeric_limits<tessera::Decimal128> {
    static constexpr bool is_integer = false;
    static tessera::Decimal128 lowest() noexcept
    {
        return tessera::Decimal128("-Inf");
    }
    static tessera::Decimal128 max() noexcept
    {
        return tessera::Decimal128("+Inf");
    }
};
