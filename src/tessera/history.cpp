...
{
    TESSERA_ASSERT_EX(begin_version <= end_version, begin_version, end_version, m_base_version);
    TESSERA_ASSERT_EX(begin_version >= m_base_version, begin_version, end_version, m_base_version);
    TESSERA_ASSERT_EX(end_version <= m_base_version + m_size, end_version, m_base_version, m_size);
    version_type n_version_type = end_version - begin_version;
    version_type offset_version_type = begin_version - m_base_version;
    TESSERA_ASSERT_EX(!util::int_cast_has_overflow<size_t>(n_version_type) &&
...
{
    TESSERA_ASSERT(version >= m_base_version);
    if (version > m_base_version) {
        ...
        // history empty.
        TESSERA_ASSERT_EX(num_entries_to_erase < m_size, num_entries_to_erase, m_size);
