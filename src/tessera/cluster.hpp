...
#ifndef TESSERA_CLUSTER_HPP
#define TESSERA_CLUSTER_HPP
...
public:
    ...
    struct State {
        ...
        size_t index = tessera::npos; // The index within the Cluster at which the object is stored.

        operator bool() const
        {
            return index != tessera::npos;
        }
    };
...
#endif /* SRC_TESSERA_CLUSTER_HPP_ */
