...
#ifndef TESSERA_ARRAY_BASIC_HPP
#define TESSERA_ARRAY_BASIC_HPP
...
public:
    ...
    bool is_null(size_t ndx) const noexcept
    {
        ...
        static_assert(tessera::is_any<T, float, double>::value, "T can only be float or double");
...
#include <tessera/array_basic_tpl.hpp>

#endif // TESSERA_ARRAY_BASIC_HPP
