...
#ifndef TESSERA_LIST_HPP
#define TESSERA_LIST_HPP

#include <tessera/collection.hpp>

#include <tessera/obj.hpp>
#include <tessera/column_mixed.hpp>
...
inline util::Optional<Mixed> LnkLst::min(size_t* return_ndx) const
{
    ...
    TESSERA_TERMINATE("Not implemented yet");
}
...
inline ObjKey LnkLst::set(size_t ndx, ObjKey value)
{
    ...
    TESSERA_ASSERT(!old.is_unresolved());
    return old;
}
