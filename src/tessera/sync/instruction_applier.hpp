...
#define TESSERA_DECLARE_INSTRUCTION_HANDLER(X) virtual void operator()(const Instruction::X&);
...
private:
    ...
    TESSERA_NORETURN void bad_transaction_log(const std::string& msg) const;
    template <class... Params>
    TESSERA_NORETURN void bad_transaction_log(const char* msg, Params&&... params) const;
};
...
#endif // TESSERA_SYNC_IMPL_INSTRUCTION_APPLIER_HPP
