...
#define TESSERA_DEFINE_INSTRUCTION_HANDLER(X) void operator()(const Instruction::X&);
    TESSERA_FOR_EACH_INSTRUCTION_TYPE(TESSERA_DEFINE_INSTRUCTION_HANDLER)
#undef TESSERA_DEFINE_INSTRUCTION_HANDLER
...
#endif // TESSERA_SYNC_CHANGESET_ENCODER_HPP
