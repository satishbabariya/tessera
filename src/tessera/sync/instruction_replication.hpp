...
#ifndef TESSERA_SYNC_IMPL_INSTRUCTION_REPLICATION_HPP
...
private:
    ...
    TESSERA_NORETURN void unsupported_instruction() const; // Throws TransformError
...
{
    TESSERA_ASSERT(!m_short_circuit);
...
#endif // TESSERA_SYNC_IMPL_INSTRUCTION_REPLICATION_HPP
