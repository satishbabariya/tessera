...
#ifndef TESSERA_NOINST_SERVER_HISTORY_HPP
#define TESSERA_NOINST_SERVER_HISTORY_HPP
...
inline void ServerHistory::prepare_for_write()
{
    ...
    TESSERA_ASSERT(m_acc->sh_changesets.is_attached());
    TESSERA_ASSERT(m_acc->root.size() == s_root_size);
}
...
#endif // TESSERA_NOINST_SERVER_HISTORY_HPP
