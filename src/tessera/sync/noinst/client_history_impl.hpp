...
#ifndef TESSERA_NOINST_CLIENT_HISTORY_IMPL_HPP
#define TESSERA_NOINST_CLIENT_HISTORY_IMPL_HPP
...
public:
    ...
    // Overriding member functions in tessera::TransformHistory
...
private:
    ...
    // Overriding member functions in tessera::_impl::History
...
public:
    ...
    // Overriding member functions in tessera::Replication
...
inline void ClientHistory::clamp_sync_version_range(version_type& begin, version_type& end) const noexcept
{
    ...
    TESSERA_ASSERT(m_progress_download.last_integrated_client_version <= begin);
...
/// \brief Create a "sync history" implementation of the tessera::Replication
/// interface.
///
...
#endif // TESSERA_NOINST_CLIENT_HISTORY_IMPL_HPP
