#ifndef TESSERA_SYNC_CLIENT_BASE_HPP
#define TESSERA_SYNC_CLIENT_BASE_HPP
...
///
/// Client reset downloads its fresh Realm copy for a Realm at path "xyx.tess" to
/// "xyz.tess.fresh". It is assumed that this path is available for use and if
...
inline std::ostream& operator<<(std::ostream& os, ConnectionState state)
{
    ...
    TESSERA_TERMINATE("Invalid ConnectionState value");
}
...
#endif // TESSERA_SYNC_CLIENT_BASE_HPP
