#ifndef TESSERA_SYNC_PROTOCOL_HPP
#define TESSERA_SYNC_PROTOCOL_HPP

#include <cstdint>
#include <system_error>

#include <tessera/error_codes.h>
...
enum class ProtocolError {
    ...
    illegal_realm_path           = RLM_SYNC_ERR_SESSION_ILLEGAL_DB_PATH,         // Illegal Realm path (BIND)
...
#endif // TESSERA_SYNC_PROTOCOL_HPP
