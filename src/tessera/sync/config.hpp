...
#ifndef TESSERA_SYNC_CONFIG_HPP
#define TESSERA_SYNC_CONFIG_HPP
...
// clang-format off
#define TESSERA_FOR_EACH_SYNC_CLIENT_HOOK_EVENT(X) \
...
#define TESSERA_DECLARE_SYNC_CLIENT_HOOK_EVENT(X) X
    TESSERA_FOR_EACH_SYNC_CLIENT_HOOK_EVENT(TESSERA_DECLARE_SYNC_CLIENT_HOOK_EVENT)
#undef TESSERA_DECLARE_SYNC_CLIENT_HOOK_EVENT
};
...
inline std::ostream& operator<<(std::ostream& os, SyncClientHookAction action)
{
    ...
    TESSERA_TERMINATE("Invalid SyncClientHookAction value");
}
