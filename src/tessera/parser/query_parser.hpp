...
#ifndef TESSERA_PARSER_QUERY_PARSER_HPP
#define TESSERA_PARSER_QUERY_PARSER_HPP
...
namespace tessera::query_parser {
...
struct AnyContext {
    ...
    bool is_null(const std::any& wrapper)
    {
        ...
        if (wrapper.type() == typeid(tessera::null)) {
            return true;
        }
        return false;
    }
...
#endif /* TESSERA_PARSER_QUERY_PARSER_HPP */
