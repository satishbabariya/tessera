...
#ifndef TESSERA_UTIL_FILE_HPP
#define TESSERA_UTIL_FILE_HPP
...
#include <filesystem>
#define TESSERA_HAVE_STD_FILESYSTEM 1
#else
#define TESSERA_HAVE_STD_FILESYSTEM 0
#endif

#if TESSERA_APPLE_DEVICE && !TESSERA_TVOS && !TESSERA_MACCATALYST
#define TESSERA_FILELOCK_EMULATION
#endif
...
#ifndef _WIN32
    DIR* m_dirp;
#elif TESSERA_HAVE_STD_FILESYSTEM
