...
#ifndef TESSERA_UTIL_ENCRYPTED_FILE_MAPPING_HPP
#define TESSERA_UTIL_ENCRYPTED_FILE_MAPPING_HPP
...
private:
    ...
    TESSERA_NORETURN void throw_decryption_error(size_t ndx, std::string_view msg) REQUIRES(m_file.mutex);
...
#else  // TESSERA_ENABLE_ENCRYPTION
class EncryptedFile {
public:
...
#endif // TESSERA_UTIL_ENCRYPTED_FILE_MAPPING_HPP
