...
#ifndef TESSERA_UTIL_BASIC_SYSTEM_ERRORS_HPP
#define TESSERA_UTIL_BASIC_SYSTEM_ERRORS_HPP
...
template <>
class is_error_code_enum<tessera::util::error::basic_system_errors> {
public:
...
#endif // TESSERA_UTIL_BASIC_SYSTEM_ERRORS_HPP
