...
#ifndef TESSERA_UTIL_SERIALIZER_HPP
#define TESSERA_UTIL_SERIALIZER_HPP
...
class Geospatial;
#endif // TESSERA_ENABLE_GEOSPATIAL
...
template <>
std::string print_value<>(tessera::null);
template <>
std::string print_value<>(StringData);
template <>
std::string print_value<>(tessera::Timestamp);
template <>
std::string print_value<>(tessera::ObjectId);
template <>
std::string print_value<>(tessera::ObjKey);

std::string print_value(tessera::ObjLink, Group*);

template <>
std::string print_value<>(tessera::UUID);
template <>
std::string print_value<>(tessera::TypeOfValue);

#if TESSERA_ENABLE_GEOSPATIAL
template <>
std::string print_value<>(const tessera::Geospatial&);
#endif // TESSERA_ENABLE_GEOSPATIAL
...
#endif // TESSERA_UTIL_SERIALIZER_HPP
