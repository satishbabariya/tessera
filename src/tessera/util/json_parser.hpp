#ifndef TESSERA_UTIL_JSON_PARSER_HPP
#define TESSERA_UTIL_JSON_PARSER_HPP
...
namespace std {
template <>
struct is_error_condition_enum<tessera::util::JSONParser::Error> {
...
{
    TESSERA_ASSERT(type == EventType::string);
    TESSERA_ASSERT(range.size() >= 2);
...
#endif // TESSERA_UTIL_JSON_PARSER_HPP
