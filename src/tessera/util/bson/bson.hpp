...
#ifndef TESSERA_BSON_HPP
#define TESSERA_BSON_HPP

#include <tessera/util/bson/indexed_map.hpp>
#include <tessera/util/bson/regular_expression.hpp>
#include <tessera/util/bson/min_key.hpp>
#include <tessera/util/bson/max_key.hpp>
#include <tessera/util/bson/mongo_timestamp.hpp>
#include <tessera/util/span.hpp>
...
public:
    ...
    Bson(tessera::Timestamp) noexcept;
    Bson(Decimal128) noexcept;
    Bson(ObjectId) noexcept;
    Bson(tessera::UUID) noexcept;
    ...
    {
        TESSERA_ASSERT(m_type == Type::Null);
        return util::none;
    }

    explicit operator int32_t() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Int32);
        return int32_val;
    }

    explicit operator int64_t() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Int64);
        return int64_val;
    }

    explicit operator bool() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Bool);
        return bool_val;
    }

    explicit operator double() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Double);
        return double_val;
    }

    explicit operator std::string&()
    {
        TESSERA_ASSERT(m_type == Bson::Type::String);
        return string_val;
    }
    ...
    {
        TESSERA_ASSERT(m_type == Bson::Type::Binary);
        return binary_val;
    }
    ...
    {
        TESSERA_ASSERT(m_type == Bson::Type::Timestamp);
        return time_val;
    }

    explicit operator tessera::Timestamp() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Datetime);
        return date_val;
    }

    explicit operator ObjectId() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::ObjectId);
        return oid_val;
    }

    explicit operator Decimal128() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Decimal128);
        return decimal_val;
    }

    explicit operator const RegularExpression&() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::RegularExpression);
        return regex_val;
    }

    explicit operator MinKey() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::MinKey);
        return min_key_val;
    }

    explicit operator MaxKey() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::MaxKey);
        return max_key_val;
    }

    explicit operator BsonDocument&() noexcept
    {
        TESSERA_ASSERT(m_type == Bson::Type::Document);
        return *document_val;
    }
    ...
    {
        TESSERA_ASSERT(m_type == Bson::Type::Array);
        return *array_val;
    }
    ...
    explicit operator tessera::UUID() const
    {
        TESSERA_ASSERT(m_type == Bson::Type::Uuid);
        return uuid_val;
    }
...
private:
    ...
    union {
        ...
        MaxKey max_key_val;
        MinKey min_key_val;
        tessera::Timestamp date_val;
        tessera::UUID uuid_val;
        // ref types
...
inline Bson::Bson(tessera::Timestamp v) noexcept
{
...
inline Bson::Bson(tessera::UUID v) noexcept
{
