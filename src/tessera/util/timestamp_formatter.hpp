...
#ifndef TESSERA_UTIL_TIMESTAMP_FORMATTER_HPP
#define TESSERA_UTIL_TIMESTAMP_FORMATTER_HPP
...
inline auto TimestampFormatter::format(std::chrono::time_point<B> time) -> string_view_type
{
    ...
    if (TESSERA_UNLIKELY(time_3 > time)) {
        --time_2;
    ...
    TESSERA_ASSERT(nanoseconds >= 0 && nanoseconds < 1000000000);
...
#endif // TESSERA_UTIL_TIMESTAMP_FORMATTER_HPP
