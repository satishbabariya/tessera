...
#ifndef TESSERA_UTIL_INTERPROCESS_MUTEX
#define TESSERA_UTIL_INTERPROCESS_MUTEX
...
#if TESSERA_PLATFORM_APPLE || TESSERA_ANDROID
#define TESSERA_ROBUST_MUTEX_EMULATION 1
#else
#define TESSERA_ROBUST_MUTEX_EMULATION 0
#endif
...
#if TESSERA_ROBUST_MUTEX_EMULATION || defined(_WIN32)
    struct SharedPart {};
#else
...
#if TESSERA_ROBUST_MUTEX_EMULATION
...
inline void InterprocessMutex::lock()
{
    ...
    TESSERA_ASSERT_RELEASE(d != WAIT_FAILED);
#else
...
#endif // #ifndef TESSERA_UTIL_INTERPROCESS_MUTEX
