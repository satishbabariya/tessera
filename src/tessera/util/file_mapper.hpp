...
#ifndef TESSERA_UTIL_FILE_MAPPER_HPP
#define TESSERA_UTIL_FILE_MAPPER_HPP
...
{
    if (auto mapping = map.get_encrypted_mapping(); TESSERA_UNLIKELY(mapping)) {
