...
#ifndef TESSERA_UTIL_INTERPROCESS_CONDVAR
#define TESSERA_UTIL_INTERPROCESS_CONDVAR
...
#define TESSERA_CONDVAR_EMULATION
#endif
...
/// for the inter-process case, if enabled by TESSERA_CONDVAR_EMULATION.
///
...
private:
    ...
    struct HandleHolder {
        ...
        {
            if (handle)
                TESSERA_ASSERT_RELEASE(CloseHandle(handle));
        }
