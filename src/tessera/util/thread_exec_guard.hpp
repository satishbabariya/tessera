#ifndef TESSERA_UTIL_THREAD_EXEC_GUARD_HPP
#define TESSERA_UTIL_THREAD_EXEC_GUARD_HPP

#include <tessera/util/signal_blocker.hpp>
...
#endif // TESSERA_UTIL_THREAD_EXEC_GUARD_HPP
