...
#ifndef TESSERA_UTIL_LOGGER_HPP
#define TESSERA_UTIL_LOGGER_HPP
...
private:
    template <class... Params>
    TESSERA_NOINLINE void do_log(const LogCategory& category, Level, const char* message, Params&&...);
};
    ...
    , m_chained_logger{base_logger}
{
    ...
    TESSERA_ASSERT(m_chained_logger);
