...
#ifndef TESSERA_UTIL_FUNCTIONAL
#define TESSERA_UTIL_FUNCTIONAL

#include <tessera/util/assert.hpp>
#include <tessera/util/type_traits.hpp>
...
public:
    ...
    {
        TESSERA_ASSERT(static_cast<bool>(*this));
