...
#ifndef TESSERA_UTIL_BACKTRACE_HPP
#define TESSERA_UTIL_BACKTRACE_HPP
...
inline std::ostream& operator<<(std::ostream& os, const tessera::util::Backtrace& bt)
{
    bt.print(os);
    return os;
}

#endif // TESSERA_UTIL_BACKTRACE_HPP
