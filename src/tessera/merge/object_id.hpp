...
#ifndef TESSERA_SYNC_OBJECT_ID_HPP
#define TESSERA_SYNC_OBJECT_ID_HPP
...
// Any unambiguous object identifier. Monostate represents NULL (can't use tessera::None or std::nullptr_t because they
...
#endif // TESSERA_SYNC_OBJECT_ID_HPP
