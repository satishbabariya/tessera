...
#include <tessera/object-store/util/apple/scheduler.hpp>
#endif
...
#if TESSERA_ANDROID && !defined(TESSERA_AOSP_VENDOR)
#define HAS_ANDROID_ALOOPER
#endif

#if defined(HAS_ANDROID_ALOOPER)
#include <tessera/object-store/util/android/scheduler.hpp>
#endif

#if defined(__EMSCRIPTEN__)
#include <tessera/object-store/util/emscripten/scheduler.hpp>
#endif

#include <tessera/object-store/util/generic/scheduler.hpp>
...
class DummyScheduler : public tessera::util::Scheduler {
public:
    bool is_on_thread() const noexcept override
    {
        return true;
...
#else
    TESSERA_TERMINATE("No built-in scheduler implementation for this platform. Register your own with "
                    "Scheduler::set_default_factory()");
#endif
#endif // TESSERA_USE_UV
}
