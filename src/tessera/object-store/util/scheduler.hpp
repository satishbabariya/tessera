...
#ifndef TESSERA_OS_UTIL_SCHEDULER
#define TESSERA_OS_UTIL_SCHEDULER

#include <tessera/util/features.h>
#include <tessera/util/functional.hpp>
#include <tessera/version_id.hpp>
...
#if (defined(TESSERA_HAVE_UV) && TESSERA_HAVE_UV && !TESSERA_PLATFORM_APPLE) ||                                            \
    (defined(TESSERA_PLATFORM_NODE) && TESSERA_PLATFORM_NODE)
#define TESSERA_USE_UV 1
#else
#define TESSERA_USE_UV 0
#endif

#if !defined(TESSERA_USE_CF) && TESSERA_PLATFORM_APPLE
#define TESSERA_USE_CF 1
#elif !defined(TESSERA_USE_ALOOPER) && TESSERA_ANDROID
#define TESSERA_USE_ALOOPER 1
#endif
...
public:
    ...
    ///
    /// In builds where `TESSERA_USE_UV=1` (such as Node.js builds), regardless of
...
#if defined(TESSERA_HAVE_UV) && TESSERA_HAVE_UV
...
#endif // TESSERA_OS_UTIL_SCHEDULER
