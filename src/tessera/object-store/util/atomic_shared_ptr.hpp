...
#ifndef TESSERA_ATOMIC_SHARED_PTR_HPP
#define TESSERA_ATOMIC_SHARED_PTR_HPP
...
template <typename T, bool = tessera::_impl::HasAtomicPtrOps<std::shared_ptr<T>>::value>
...
#endif // TESSERA_ATOMIC_SHARED_PTR_HPP
