...
#ifndef TESSERA_OS_OBJECT_ACCESSOR_IMPL_HPP
#define TESSERA_OS_OBJECT_ACCESSOR_IMPL_HPP
...
public:
                                                ...
                                                size_t /* property_index */) const
    {
        ...
        if (auto geo = std::any_cast<Geospatial>(&dict)) {
            ...
            TESSERA_ASSERT_EX(false, prop.name); // unexpected property type
        }
#endif
...
#endif // TESSERA_OS_OBJECT_ACCESSOR_IMPL_HPP
