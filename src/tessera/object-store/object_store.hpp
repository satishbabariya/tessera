...
#ifndef TESSERA_OBJECT_STORE_HPP
#define TESSERA_OBJECT_STORE_HPP
...
public:
    ...
    static tessera::TableRef table_for_object_type(Group& group, StringData object_type);
    static tessera::ConstTableRef table_for_object_type(Group const& group, StringData object_type);
...
#endif /* defined(TESSERA_OBJECT_STORE_HPP) */
