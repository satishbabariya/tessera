...
#ifndef TESSERA_OS_SYNC_MANAGER_HPP
#define TESSERA_OS_SYNC_MANAGER_HPP

#include <tessera/object-store/sync/sync_client_config.hpp>
...
#endif // TESSERA_OS_SYNC_MANAGER_HPP
