...
#ifndef TESSERA_COLLECTION_NOTIFICATIONS_HPP
#define TESSERA_COLLECTION_NOTIFICATIONS_HPP

#include <tessera/path.hpp>
#include <tessera/object-store/index_set.hpp>
#include <tessera/object-store/util/atomic_shared_ptr.hpp>
...
#endif // TESSERA_COLLECTION_NOTIFICATIONS_HPP
