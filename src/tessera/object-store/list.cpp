...
#define TESSERA_PRIMITIVE_LIST_TYPE(T)                                                                                 \
...
TESSERA_PRIMITIVE_LIST_TYPE(bool)
TESSERA_PRIMITIVE_LIST_TYPE(int64_t)
TESSERA_PRIMITIVE_LIST_TYPE(float)
TESSERA_PRIMITIVE_LIST_TYPE(double)
TESSERA_PRIMITIVE_LIST_TYPE(StringData)
TESSERA_PRIMITIVE_LIST_TYPE(BinaryData)
TESSERA_PRIMITIVE_LIST_TYPE(Timestamp)
TESSERA_PRIMITIVE_LIST_TYPE(ObjKey)
TESSERA_PRIMITIVE_LIST_TYPE(ObjectId)
TESSERA_PRIMITIVE_LIST_TYPE(Decimal)
TESSERA_PRIMITIVE_LIST_TYPE(UUID)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<bool>)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<int64_t>)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<float>)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<double>)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<ObjectId>)
TESSERA_PRIMITIVE_LIST_TYPE(util::Optional<UUID>)
...
#undef TESSERA_PRIMITIVE_LIST_TYPE
} // namespace tessera
