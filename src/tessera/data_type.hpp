...
#ifndef TESSERA_DATA_TYPE_HPP
#define TESSERA_DATA_TYPE_HPP
...
typedef tessera::StringData String;
typedef tessera::BinaryData Binary;
typedef tessera::Decimal128 Decimal;

struct ColumnType;

struct DataType {
    enum class Type {
        // Note: Value assignments must be kept in sync with <tessera/column_type.h>
