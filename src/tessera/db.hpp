...
#ifndef TESSERA_DB_HPP
#define TESSERA_DB_HPP

#include <tessera/db_options.hpp>
#include <tessera/group.hpp>
#include <tessera/handover_defs.hpp>
#include <tessera/impl/changeset_input_stream.hpp>
...
public:
    ...
    using VersionID = tessera::VersionID;
...
private:
    ...
    struct ReadLockInfo {
        ...
        {
            TESSERA_ASSERT_RELEASE_EX((m_top_ref & 7) == 0 && m_top_ref < m_file_size, m_version, m_reader_idx,
