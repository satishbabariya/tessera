...
#ifndef TESSERA_INDEX_STRING_HPP
#define TESSERA_INDEX_STRING_HPP
...
#include <tessera/search_index.hpp>
...
public:
    ...
    static bool type_supported(tessera::DataType type)
    {
...
{
    TESSERA_ASSERT_EX(Array::get_context_flag_from_header(alloc.translate(ref)), ref, size_t(alloc.translate(ref)));
...
#endif // TESSERA_INDEX_STRING_HPP
