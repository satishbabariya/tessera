...
static std::ostream& operator<<(std::ostream& out, const tessera::TokenInfo& info)
{
...
static std::ostream& operator<<(std::ostream& out, const tessera::TokenInfoMap& infoMap)
{
