...
#ifndef TESSERA_NMMINTRIN_H
#define TESSERA_NMMINTRIN_H
...
#if !defined(_MSC_VER) && defined(TESSERA_COMPILER_SSE)
...
#endif // !defined(_MSC_VER) && defined(TESSERA_COMPILER_SSE)
#endif
